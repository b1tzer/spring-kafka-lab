...
/**
 * Centralized activity log store for websocket broadcasting and future
 * extensions.
 */
@Service
public class LabActivityLogService {
    ...
    public synchronized Map<String, Object> append(String level, String action, String detail, String topic,

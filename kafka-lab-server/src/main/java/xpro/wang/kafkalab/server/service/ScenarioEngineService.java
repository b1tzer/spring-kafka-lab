...
public class ScenarioEngineService {
    ...
    public ScenarioEngineService(ProducerLabService producerLabService,
    ...
    public Map<String, Object> run(ScenarioRunRequest request) throws Exception {
        ...
        return switch (scenarioName) {
            ...
            default -> Map.of(
                    ...
                    "supported", new String[]{"rebalance", "consumer-lag", "poison-message", "broker-crash", "exactly-once"}
            );
        };
    }
    ...
    private Map<String, Object> runRebalance(Map<String, Object> parameters) {
        ...
        return Map.of(
                "scenario", "rebalance",
            "status", ScenarioStatus.TRIGGERED.name(),
                "groupId", groupId,
                "topic", topic,
                "hint", "Check consumer group assignment changes in Kafka UI"
        );
    }
    ...
    private Map<String, Object> runLag(Map<String, Object> parameters) throws Exception {
        ...
        return Map.of(
            ...
            "status", ScenarioStatus.TRIGGERED.name(),
                "topic", topic,
                "messageCount", count,
                "hint", "Start slow consumer and observe lag metrics"
        );
    }
    ...
    private Map<String, Object> runPoison(Map<String, Object> parameters) {
        return Map.of(
            ...
            "status", ScenarioStatus.MANUAL_STEP_REQUIRED.name(),
                "hint", "Implement listener exception + retry + DLT topic in your consumer module"
        );
    }
    ...
    private Map<String, Object> runExactlyOnce(Map<String, Object> parameters) throws Exception {
        ...
        return Map.of(
            ...
            "status", ScenarioStatus.TRIGGERED.name(),
                "topic", topic,
                "hint", "Verify no duplicate messages under retries"
        );
    }

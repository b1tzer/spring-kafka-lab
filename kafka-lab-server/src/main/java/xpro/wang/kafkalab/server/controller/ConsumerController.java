...
public class ConsumerController {
    ...
    public ApiResponse<Map<String, Object>> start(@Valid @RequestBody ConsumerStartRequest request) {
        ...
        labRealtimeWebSocketHandler.publish(LabRealtimeEventType.CONSUMER_CHANGED, Map.of("action",
                LabRealtimeAction.STARTED.name(), "groupId", request.groupId(), "topic", request.topic()));
    ...
    public ApiResponse<Map<String, Object>> stop(@Valid @RequestBody ConsumerStopRequest request) {
        ...
        labRealtimeWebSocketHandler.publish(LabRealtimeEventType.CONSUMER_CHANGED,
    ...
    public ApiResponse<Map<String, Object>> register(@Valid @RequestBody ConsumerRegisterRequest request) {
        ...
        labRealtimeWebSocketHandler.publish(LabRealtimeEventType.CONSUMER_CHANGED, Map.of("action",
                LabRealtimeAction.CREATED.name(), "clientId", data.get("clientId"), "groupId", data.get("groupId")));
    ...
    public ApiResponse<Map<String, Object>> startByClientId(@PathVariable String clientId) {
        ...
        labRealtimeWebSocketHandler.publish(LabRealtimeEventType.CONSUMER_CHANGED, Map.of("action",
                LabRealtimeAction.STARTED.name(), "clientId", clientId, "groupId", data.get("groupId")));
        return ApiResponse.ok("Consumer started", data);
    }
    ...
    public ApiResponse<Map<String, Object>> stopByClientId(@PathVariable String clientId) {
        ...
        labRealtimeWebSocketHandler.publish(LabRealtimeEventType.CONSUMER_CHANGED, Map.of("action",
                LabRealtimeAction.STOPPED.name(), "clientId", clientId, "groupId", data.get("groupId")));
        return ApiResponse.ok("Consumer stopped", data);
    }

    @PutMapping("/{clientId}/topics")
    public ApiResponse<Map<String, Object>> updateTopics(@PathVariable String clientId,
        ...
        labRealtimeWebSocketHandler.publish(LabRealtimeEventType.CONSUMER_CHANGED,
                Map.of("action", LabRealtimeAction.UPDATED.name(), "clientId", clientId, "topics", request.topics()));

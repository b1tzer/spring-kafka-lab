...
public class TopicController {
   ...
   * Creates a new topic.
   *
   * @param request topic create request
   * @return operation response
   * @throws Exception when create fails
   */
  @PostMapping
  public ApiResponse<Void> create(@Valid @RequestBody TopicRequest request) throws Exception {
    ...
    labRealtimeWebSocketHandler.publish(
        LabRealtimeEventType.TOPIC_CHANGED,
   ...
   */
  @GetMapping("/{name}")
  public ApiResponse<Map<String, Object>> describe(@PathVariable("name") String name)
      throws Exception {

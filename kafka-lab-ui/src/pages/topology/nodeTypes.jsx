...
import { CloudServerOutlined, DownloadOutlined, UploadOutlined } from '@ant-design/icons';

export const ProducerNode = ({ data }) => (
  <div className="topo-node producer">
    <Handle type="source" position={Position.Right} id="out" />
    <div className="topo-node-title"><UploadOutlined /> Producer</div>
...
export const ConsumerNode = ({ data }) => (
  <div className={`topo-node consumer ${Date.now() - (data.shakeAt || 0) < 220 ? 'consumer-shake' : ''}`}>
    <Handle type="target" position={Position.Left} id="in" />
    <div className="topo-node-title">Consumer <DownloadOutlined /></div>
...
export const BrokerNode = ({ data }) => (
  <div className="topo-broker">
    <div className="topo-broker-head"><CloudServerOutlined /> Broker {data.brokerId}</div>
